...
2. 用瀏覽器（Chrome / Safari / Edge）開啟即可，**不需要安裝任何軟體**

### 方式二：GitHub Pages 線上版

直接開啟：

```
https://weber.github.io/id-watermark-tool/
```

> ⚠️ 即使透過網址開啟，圖片仍在本機瀏覽器內處理，不會上傳至任何伺服器。
